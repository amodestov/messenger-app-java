...
import static com.aleksandrmodestov.messenger.StringUtils.getTrimmedValue;
    ...
    private void setUpClickListeners() {
        buttonSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String secondName = getTrimmedValue(editTextSecondName);
                int age = Integer.parseInt(getTrimmedValue(editTextAge));
                viewModel.signUp(email, password, firstName, secondName, age);
            }
        });
    }

    private void observeViewModel() {
        viewModel.getSignUpErrorMessage().observe(RegistrationActivity.this, new Observer<String>() {
                    @Override
        ...
        viewModel.getUser().observe(RegistrationActivity.this,
